    ...
    <div class="space-y-10">
        ...
        <section class="animate-in fade-in slide-in-from-bottom-4 duration-700 delay-150">
            ...
            <div class="mt-4 px-2">
                <form wire:submit="updateProfile" class="space-y-6">
                    <x-ios-input label="{{ __('messages.profile_label_name') }}" wire:model="name" type="text"
                        icon="m15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />

                    <x-ios-input label="{{ __('messages.profile_label_email') }}" wire:model="email" type="email"
                        dir="ltr"
                        icon="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />

                    <x-ios-input label="{{ __('messages.profile_label_birthday') }}" wire:model="birthday"
                        type="date"
                    ...
                    <div class="pt-4">
                        <x-ios-button type="submit" wire:loading.attr="disabled" target="updateProfile">
                            <span wire:loading.remove
                                wire:target="updateProfile">{{ __('messages.save_changes') }}</span>
        ...
        <section class="animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
            ...
            <x-ios-input-group class="mt-4">
                <!-- Change Phone -->
                <a href="{{ route('phone.change') }}" wire:navigate
                    ...
                    <div class="flex flex-col">
                        ...
                        <span
                            class="text-[11px] text-gray-500 font-bold uppercase tracking-wider mt-0.5">{{ auth()->user()->phone }}</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <span
                            class="text-[10px] font-black text-banhafade-accent uppercase bg-banhafade-accent/10 px-2 py-0.5 rounded-full">{{ __('messages.profile_change_phone_btn') ?? 'تغيير' }}</span>

<div x-data="{
    ...
    <div class="pt-16 pb-8 px-2 w-full">
        ...
        <div class="mt-6 text-sm text-gray-500 font-tajawal text-center">
            ...
            <button type="button" wire:click="resend" wire:loading.attr="disabled" :disabled="cooldown > 0" :class="cooldown > 0 ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'" class="text-fadebook-accent hover:text-red-600 font-bold transition-colors disabled:opacity-50 disabled:cursor-not-allowed">

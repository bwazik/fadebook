...
<header class="sticky top-0 z-40 -mx-4 px-5 py-3
    ...
    @if($backRoute)
        <a href="{{ route($backRoute) }}" wire:navigate
           class="p-2 -mr-1 rounded-full active:bg-black/5 dark:active:bg-white/10 transition-all text-[--color-fadebook-accent] shrink-0">

...
>
    ...
    <div
        ...
        class="absolute z-50 w-full mt-2 rounded-2xl
               bg-white/95 dark:bg-[#2c2c2e]/95
               backdrop-blur-3xl border border-black/5 dark:border-white/10
                ...
                <li wire:key="select-opt-{{ $val }}">
                    ...
                    >
                        ...
                        <svg x-show="value == '{{ $val }}'"
                             class="w-4 h-4 text-[--color-fadebook-accent] shrink-0"
                             fill="none" viewBox="0 0 24 24" stroke="currentColor">

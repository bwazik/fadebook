    ...
    public function run(): void
    {
        $settings = [
            'terms_content' => implode("\n\n", [
                '١. الشروط العامة',
                'باستخدامك لموقع فيدبوك، فأنت بتوافق على كل الشروط دي. التطبيق ده معمول عشان يسهل عليك حجز مواعيد الحلاقة، وإحنا بنحاول دايماً نوفرلك أحسن تجربة.',
                ...
                '٣. الدفع والأسعار',
                'الأسعار الموضحة هي أسعار المحلات نفسها. فيدبوك مش بيزود مصاريف خفية، لكن ممكن يكون في رسوم حجز بسيطة في بعض الحالات.',
                '٤. السلوك العام',
                'إحنا بنهتم بالاحترام المتبادل بين الزباين والباربرز. أي سلوك مش لائق ممكن يؤدي لحظر الحساب فوراً.',
                '٥. التعديلات',
                'فيدبوك حقها تعدل الشروط دي في أي وقت، وهنبلغكم بأي تغييرات مهمة.',
            ]),

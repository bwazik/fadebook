...
- Eloquent models MUST use PHP 8 attributes `#[Fillable]` and `#[Hidden]` instead of protected properties.
- `vendor/bin/pint --dirty --format agent` MUST be run after every PHP file change.
